...
def cosyrun(b, q1s, q2s, q3s, q4s, q5s, q6s, q7s ):
    
    cosyFilename = 'SwarmCosy' + str(b) + '.fox'
    tempresFilename = 'temp-results' + str(b)
    # creating input file
    ...
    try:
        ...
        print('bee = %d q1 = %.6f q2 = %.6f q3 = %.6f q4 = %.6f q5 = %.6f q6 = %.6f q7 = %.6f'  %(b, q1s, q2s, q3s, q4s, q5s, q6s, q7s) )   
        resol = 0
